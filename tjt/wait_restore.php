    ...
    <script src="recycle/js/jquery-1.9.1.min.js"></script> 
 	...
 	<style type="text/css">
		  ...
		  body {
    background-image: url('recycle/images/crusher.jpg');
...
document.addEventListener('dragstart', e => e.preventDefault());   // 禁止拖动
 ...
 include("incdb.php");
		...
		$sql = "update command set command='4' "; 
...
setTimeout("javascript:location.href='machine_error.php'", 60000); 
...
<div class='text' id='myButton' style='margin-left:170px;top:260px;color:#000'  > 60  </div>
